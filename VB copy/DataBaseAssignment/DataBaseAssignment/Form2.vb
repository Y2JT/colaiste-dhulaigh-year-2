Public Class Form2
    ...
    Private Sub btnDone_Click(sender As Object, e As EventArgs) Handles btnDone.Click
        ...
        If NameTextBox.Text = "" Or IsNumeric(NameTextBox.Text) Then
            Beep()
            MessageBox.Show("Please Enter a Valid Name", "Alert")
            NameTextBox.Focus()
            Exit Sub
        End If
        ...
        If OverdraftCheckBox.CheckState = CheckState.Indeterminate Then
            Beep()
            MessageBox.Show("Please select an Overdraft option", "Alert")
            Exit Sub
        End If
        'check for non digits and minus
        If OverdraftCheckBox.CheckState = CheckState.Unchecked And Val(BalanceTextBox.Text) < 0 Then
            Beep()
            MessageBox.Show("Cannont have a NEGATIVE value with NO Overdraft selected", "Alert")
            Exit Sub
        End If
